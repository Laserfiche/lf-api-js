...
describe('IconUtils', () => {
    it('should return Icon url given an Icon id', () => {
        ...
        const expectedResultByInput = {
            '': 'https://lfxstatic.com/npm/@laserfiche/lf-resource-library@5/resources/icons/document-icons.svg#',
            'a': 'https://lfxstatic.com/npm/@laserfiche/lf-resource-library@5/resources/icons/document-icons.svg#a',
